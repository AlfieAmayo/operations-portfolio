...
<a href="https://kk-dashboard-wine.vercel.app" class="dashboard-cta" target="_blank">
  <div>
    <div class="cta-label">Live artefact</div>
...
<div class="amber-item">
  <div class="amber-item-title">Which deliveries succeeded by absorbing a problem, not solving it?</div>
</div>

<div class="amber-item">
  <div class="amber-item-title">Where was reliability chosen over margin?</div>
</div>

<div class="amber-item">
  <div class="amber-item-title">What does normal look like right now?</div>
</div>

<div class="amber-item">
  <div class="amber-item-title">What should be done before the next order goes in?</div>
</div>
